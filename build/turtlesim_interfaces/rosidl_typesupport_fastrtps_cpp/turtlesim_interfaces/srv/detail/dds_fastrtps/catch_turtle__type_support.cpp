...
#include "turtlesim_interfaces/srv/detail/catch_turtle__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const turtlesim_interfaces::srv::CatchTurtle_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtlesim_interfaces::srv::CatchTurtle_Request *>(
    untyped_ros_message);
...
{
  return &turtlesim_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const turtlesim_interfaces::srv::CatchTurtle_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<turtlesim_interfaces::srv::CatchTurtle_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &turtlesim_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Response__handle;
}
...
{
  return &turtlesim_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle__handle;
}
