...
#include "turtlesim_interfaces/msg/detail/turtle_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const turtlesim_interfaces::msg::Turtle &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  turtlesim_interfaces::msg::Turtle &);
...
cdr_serialize(
  const turtlesim_interfaces::msg::TurtleArray & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: turtles
  {
    ...
    for (size_t i = 0; i < size; i++) {
      turtlesim_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtlesim_interfaces::msg::TurtleArray & ros_message)
{
  // Member: turtles
  {
    uint32_t cdrSize;
    ...
    for (size_t i = 0; i < size; i++) {
      turtlesim_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: turtles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        turtlesim_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: turtles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        turtlesim_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Turtle(
...
{
  auto typed_message =
    static_cast<const turtlesim_interfaces::msg::TurtleArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtlesim_interfaces::msg::TurtleArray *>(
    untyped_ros_message);
...
{
  return &turtlesim_interfaces::msg::typesupport_fastrtps_cpp::_TurtleArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlesim_interfaces, msg, TurtleArray)() {
  return &turtlesim_interfaces::msg::typesupport_fastrtps_cpp::_TurtleArray__handle;
}
