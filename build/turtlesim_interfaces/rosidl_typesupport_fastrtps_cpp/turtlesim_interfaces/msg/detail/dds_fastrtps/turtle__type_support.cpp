...
#include "turtlesim_interfaces/msg/detail/turtle__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const turtlesim_interfaces::msg::Turtle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtlesim_interfaces::msg::Turtle *>(
    untyped_ros_message);
...
{
  return max_serialized_size_Turtle(full_bounded, 0);
}
...
{
  return &turtlesim_interfaces::msg::typesupport_fastrtps_cpp::_Turtle__handle;
}
